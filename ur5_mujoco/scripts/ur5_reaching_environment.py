...
class UR5ReachingEnvironment(UR5SimulationEnvironment):
    def __init__(self, config):
        config.xml_path = "/home/tatsu/internship/sac_workspace/ur5_mujoco/model/ur5_reaching.xml"
    ...
    def _get_reward(self, current_state, action, next_state):
        tcp = self.sim.data.get_body_xpos('tcp')
