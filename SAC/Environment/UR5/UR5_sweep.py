...
from ur5_mujoco.scripts.ur5_sweeping_environment import UR5SweepingEnvironment
from ur5_mujoco.scripts.config import Config


class UR5Sweep(InterfaceEnvironment):
    def __init__(self, userDefinedSettings):
        config = Config()
        self.env = UR5SweepingEnvironment(config)
